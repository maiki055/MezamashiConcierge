...
extension UIColor {
    ...
    class func mainColor() -> UIColor {
        return self.color(decRed: 0, decGreen: 0, decBlue: 0, alpha: 1)
    }
    class func subColor01() -> UIColor {
        return self.color(decRed: 255, decGreen: 255, decBlue:2550, alpha: 1)
    }
    class func subColor02() -> UIColor {
        return self.color(decRed: 218, decGreen: 165, decBlue: 32, alpha: 1)
    }
}
